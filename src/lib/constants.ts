...
export const COURSES: Course[] = [
  ...
  },
  {
    ...
    syllabus: [
      ...
      "Troubleshooting the meditative life",
    ],
...
export const GUIDANCE_SUBJECTS: GuidanceSubject[] = [
  ...
  { slug: "counselling-rajaswala", name: "Rajaswalā · Preconception Counselling", deva: "रजस्वला", priceINR: 2000 },
...
export const CONSULTATION_PRODUCTS: Course[] = [
  ...
  },
  {
    ...
    deva: "परामर्श",
    tradition: "One to one with Guruji",
    excerpt: "All seven counselling fields, couple, preconception, yogic life, post trauma, femininity, masculinity, child, at a bundled price.",
    syllabus: [],
