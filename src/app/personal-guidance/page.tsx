...
export const metadata: Metadata = {
  title: "One-on-One Spiritual Guidance — Online Counselling from Rishikesh",
  description:
    "Personal spiritual guidance from Rishikesh, India — one-on-one Vedanta consultation and spiritual counselling online with Acharya Bhagyashree Joshi Ji. Meditation, prāṇāyāma, jyotiṣa, contemplation.",
};
